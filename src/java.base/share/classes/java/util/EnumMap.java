    ...
    implements java.io.Serializable, Cloneable
{
     ...
     */
    @SideEffectFree
    public @IteratorPolyShrinkable @PolyShrinkable @Ungrowable Set<K> keySet(@PolyShrinkable EnumMap<K, V> this) {
        Set<K> ks = keySet;
        if (ks == null) {
            ks = new KeySet();
            keySet = ks;
     ...
     */
    @SideEffectFree
    public @IteratorPolyShrinkable @PolyShrinkable @Ungrowable Collection<V> values(@PolyShrinkable EnumMap<K, V> this) {
     ...
     */
    @SideEffectFree
    public @IteratorPolyShrinkable @PolyShrinkable @Ungrowable Set<Map.@PolyModifiable Entry<K,V>> entrySet(@PolyModifiable EnumMap<K, V> this) {
