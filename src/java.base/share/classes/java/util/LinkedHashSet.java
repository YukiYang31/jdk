...
public class LinkedHashSet<E>
     ...
     */
    public @Modifiable @IteratorPreserveRemove LinkedHashSet(int initialCapacity, float loadFactor) {
     ...
     *              than zero
     */
    public @Modifiable @IteratorPreserveRemove LinkedHashSet(int initialCapacity) {
     ...
     */
    public @Modifiable @IteratorPreserveRemove LinkedHashSet() {
        super(16, .75f, true);
    }
     ...
     */
    public @Modifiable @IteratorPreserveRemove LinkedHashSet(Collection<? extends E> c) {
