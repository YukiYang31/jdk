...
public class HashMap<K,V> extends AbstractMap<K,V>
     ...
     */
    @SideEffectFree
    public @IteratorPolyShrinkable @PolyShrinkable @Ungrowable Set<@KeyFor({"this"}) K> keySet(@PolyShrinkable @GuardSatisfied HashMap<K, V> this) {
        Set<K> ks = keySet;
        if (ks == null) {
            ks = new KeySet();
            keySet = ks;
     ...
     */
    @SideEffectFree
    public @IteratorPolyShrinkable @PolyShrinkable @Ungrowable Collection<V> values(@PolyShrinkable @GuardSatisfied HashMap<K, V> this) {
     ...
     */
    @SideEffectFree
    public @IteratorPolyShrinkable @PolyShrinkable @Ungrowable Set<Map.@PolyModifiable Entry<@KeyFor({"this"}) K,V>> entrySet(@PolyShrinkable @GuardSatisfied HashMap<K, V> this) {
