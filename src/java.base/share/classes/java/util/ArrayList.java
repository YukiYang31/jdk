...
import org.checkerframework.checker.modifiability.qual.Unknown;
        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     * @throws IndexOutOfBoundsException {@inheritDoc}
     */
    public E remove(@GuardSatisfied @Shrinkable @Modifiable ArrayList<E> this, @NonNegative int index) {
        Objects.checkIndex(index, size);
     ...
     */
    public boolean remove(@GuardSatisfied @Shrinkable @Modifiable ArrayList<E> this, @GuardSatisfied @Nullable @UnknownSignedness Object o) {
        final Object[] es = elementData;
