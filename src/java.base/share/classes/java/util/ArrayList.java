        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     */
    @SideEffectFree
    public @Modifiable @IteratorPolyShrink ArrayList(@NonNegative int initialCapacity) {
     ...
     */
    @SideEffectFree
    public @Modifiable @IteratorPolyShrink ArrayList() {
     ...
     */
    @SideEffectFree
    public @Modifiable @IteratorPolyShrink @PolyNonEmpty ArrayList(@PolyNonEmpty Collection<? extends E> c) {
        Object[] a = c.toArray();
        if ((size = a.length) != 0) {
     ...
     */
    @SideEffectFree
    public @Modifiable @IteratorPolyShrink clone(@GuardSatisfied ArrayList<E> this) {
        try {
