...
public class PriorityQueue<E extends @NonNull Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPolyShrink PriorityQueue() {
     ...
     *         than 1
     */
    public @Modifiable @IteratorPolyShrink PriorityQueue(@Positive int initialCapacity) {
     ...
     * @since 1.8
     */
    public @Modifiable @IteratorPolyShrink PriorityQueue(Comparator<? super E> comparator) {
     ...
     */
    public @Modifiable @IteratorPolyShrink @PolyNonEmpty PriorityQueue(@PolyNonEmpty Collection<? extends E> c) {
     ...
     *         of its elements are null
     */
    public @Modifiable @IteratorPolyShrink PriorityQueue(PriorityQueue<? extends E> c) {
     ...
     *         of its elements are null
     */
    public @Modifiable @IteratorPolyShrink PriorityQueue(SortedSet<? extends E> c) {
        this.comparator = (Comparator<? super E>) c.comparator();
