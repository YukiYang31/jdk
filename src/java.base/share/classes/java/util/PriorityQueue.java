...
public class PriorityQueue<E extends @NonNull Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPreservesRemove PriorityQueue() {
     ...
     *         than 1
     */
    public @Modifiable @IteratorPreservesRemove PriorityQueue(@Positive int initialCapacity) {
     ...
     * @since 1.8
     */
    public @Modifiable @IteratorPreservesRemove PriorityQueue(Comparator<? super E> comparator) {
     ...
     */
    public @Modifiable @IteratorPreservesRemove @PolyNonEmpty PriorityQueue(@PolyNonEmpty Collection<? extends E> c) {
     ...
     *         of its elements are null
     */
    public @Modifiable @IteratorPreservesRemove PriorityQueue(PriorityQueue<? extends E> c) {
     ...
     *         of its elements are null
     */
    public @Modifiable @IteratorPreservesRemove PriorityQueue(SortedSet<? extends E> c) {
        this.comparator = (Comparator<? super E>) c.comparator();
