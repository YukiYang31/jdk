...
public class PriorityQueue<E extends @NonNull Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPreserveRemove PriorityQueue() {
     ...
     *         than 1
     */
    public @Modifiable @IteratorPreserveRemove PriorityQueue(@Positive int initialCapacity) {
     ...
     * @since 1.8
     */
    public @Modifiable @IteratorPreserveRemove PriorityQueue(Comparator<? super E> comparator) {
     ...
     */
    public @Modifiable @IteratorPreserveRemove @PolyNonEmpty PriorityQueue(@PolyNonEmpty Collection<? extends E> c) {
     ...
     *         of its elements are null
     */
    public @Modifiable @IteratorPreserveRemove PriorityQueue(PriorityQueue<? extends E> c) {
     ...
     *         of its elements are null
     */
    public @Modifiable @IteratorPreserveRemove PriorityQueue(SortedSet<? extends E> c) {
        this.comparator = (Comparator<? super E>) c.comparator();
