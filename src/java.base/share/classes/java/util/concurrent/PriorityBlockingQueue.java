...
public class PriorityBlockingQueue<E extends Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPolyShrinkable PriorityBlockingQueue() {
     ...
     *         than 1
     */
    public @Modifiable @IteratorPolyShrinkable PriorityBlockingQueue(int initialCapacity) {
     ...
     */
    public @Modifiable @IteratorPolyShrinkable PriorityBlockingQueue(Collection<? extends E> c) {
