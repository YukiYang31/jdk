...
public class PriorityBlockingQueue<E extends Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPreservesRemove PriorityBlockingQueue() {
     ...
     *         than 1
     */
    public @Modifiable @IteratorPreservesRemove PriorityBlockingQueue(int initialCapacity) {
     ...
     */
    public @Modifiable @IteratorPreservesRemove PriorityBlockingQueue(Collection<? extends E> c) {
