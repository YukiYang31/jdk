...
public class PriorityBlockingQueue<E extends Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPreserveRemove PriorityBlockingQueue() {
     ...
     *         than 1
     */
    public @Modifiable @IteratorPreserveRemove PriorityBlockingQueue(int initialCapacity) {
     ...
     */
    public @Modifiable @IteratorPreserveRemove PriorityBlockingQueue(Collection<? extends E> c) {
