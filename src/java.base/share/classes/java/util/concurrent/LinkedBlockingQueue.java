...
public class LinkedBlockingQueue<E extends Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPreserveRemove LinkedBlockingQueue() {
     ...
     *         than zero
     */
    public @Modifiable @IteratorPreserveRemove LinkedBlockingQueue(int capacity) {
     ...
     */
    public @Modifiable @IteratorPreserveRemove LinkedBlockingQueue(Collection<? extends E> c) {
        this(Integer.MAX_VALUE);
        final ReentrantLock putLock = this.putLock;
