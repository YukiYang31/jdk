...
public class LinkedBlockingQueue<E extends Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPolyShrink LinkedBlockingQueue() {
     ...
     *         than zero
     */
    public @Modifiable @IteratorPolyShrink LinkedBlockingQueue(int capacity) {
     ...
     */
    public @Modifiable @IteratorPolyShrink LinkedBlockingQueue(Collection<? extends E> c) {
        this(Integer.MAX_VALUE);
        final ReentrantLock putLock = this.putLock;
