...
public class LinkedBlockingQueue<E extends Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPreservesRemove LinkedBlockingQueue() {
     ...
     *         than zero
     */
    public @Modifiable @IteratorPreservesRemove LinkedBlockingQueue(int capacity) {
     ...
     */
    public @Modifiable @IteratorPreservesRemove LinkedBlockingQueue(Collection<? extends E> c) {
        this(Integer.MAX_VALUE);
        final ReentrantLock putLock = this.putLock;
