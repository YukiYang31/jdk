...
public class ArrayBlockingQueue<E extends Object> extends AbstractQueue<E>
     ...
     */
    public @Modifiable @IteratorPreservesRemove ArrayBlockingQueue(int capacity) {
        this(capacity, false);
    }
     ...
     * @throws IllegalArgumentException if {@code capacity < 1}
     */
    public @Modifiable @IteratorPreservesRemove ArrayBlockingQueue(int capacity, boolean fair) {
        if (capacity <= 0)
