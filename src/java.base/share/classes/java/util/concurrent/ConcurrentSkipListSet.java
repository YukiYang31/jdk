...
public class ConcurrentSkipListSet<E extends @NonNull Object>
     ...
     */
    public @Modifiable @IteratorPolyShrink ConcurrentSkipListSet() {
     ...
     */
    public @Modifiable @IteratorPolyShrink ConcurrentSkipListSet(@Nullable Comparator<? super E> comparator) {
     ...
     */
    public @Modifiable @IteratorPolyShrink ConcurrentSkipListSet(Collection<? extends E> c) {
        m = new ConcurrentSkipListMap<E,Object>();
        addAll(c);
    }
     ...
     *         of its elements are null
     */
    public @Modifiable @IteratorPolyShrink ConcurrentSkipListSet(SortedSet<E> s) {
     ...
     * For use by submaps
     */
    @Modifiable @IteratorPolyShrink ConcurrentSkipListSet(ConcurrentNavigableMap<E,Object> m) {
        this.m = m;
    }
     ...
     */
    @SideEffectFree
    public @Modifiable @IteratorPolyShrink ConcurrentSkipListSet<E> clone() {
        try {
