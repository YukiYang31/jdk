...
public class LinkedBlockingDeque<E extends Object>
     ...
     */
    public @Modifiable @IteratorPreservesRemove LinkedBlockingDeque() {
     ...
     */
    public @Modifiable @IteratorPreservesRemove LinkedBlockingDeque(int capacity) {
     ...
     */
    public @Modifiable @IteratorPreservesRemove LinkedBlockingDeque(Collection<? extends E> c) {
        this(Integer.MAX_VALUE);
        addAll(c);
    }
