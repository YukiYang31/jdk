    ...
    implements List<E>, Deque<E>, Cloneable, java.io.Serializable
{
    ...
    */
     ...
     */
    public @Modifiable @IteratorPolyShrink LinkedList() {
    }
     ...
     */
    public @Modifiable @IteratorPolyShrink @PolyNonEmpty LinkedList(@PolyNonEmpty Collection<? extends E> c) {
        this();
        addAll(c);
    }
     ...
     */
    @SideEffectFree
    public @Modifiable @IteratorPolyShrink Object clone(@GuardSatisfied LinkedList<E> this) {
