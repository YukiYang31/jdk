    ...
    implements Cloneable, java.io.Serializable permits JumboEnumSet, RegularEnumSet
{
    ...
    @Modifiable @IteratorPolyShrink EnumSet(Class<E>elementType, Enum<?>[] universe) {
     ...
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> noneOf(Class<E> elementType) {
     ...
     * @throws NullPointerException if {@code elementType} is null
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> allOf(Class<E> elementType) {
     ...
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> copyOf(EnumSet<E> s) {
        return s.clone();
    }
     ...
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> copyOf(Collection<E> c) {
     ...
     * @throws NullPointerException if {@code s} is null
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> complementOf(EnumSet<E> s) {
     ...
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> of(E e) {
     ...
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> of(E e1, E e2) {
     ...
     * @return an enum set initially containing the specified elements
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> of(E e1, E e2, E e3) {
        EnumSet<E> result = noneOf(e1.getDeclaringClass());
        result.add(e1);
        result.add(e2);
        result.add(e3);
     ...
     * @return an enum set initially containing the specified elements
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> of(E e1, E e2, E e3, E e4) {
        EnumSet<E> result = noneOf(e1.getDeclaringClass());
        result.add(e1);
        result.add(e2);
        result.add(e3);
     ...
     */
    @SafeVarargs
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> of(E first, E... rest) {
     ...
     */
    public static <E extends Enum<E>> @Modifiable @IteratorPolyShrink EnumSet<E> range(E from, E to) {
    ...
    @DoesNotUnrefineReceiver("modifiability")
    public @Modifiable @IteratorPolyShrink EnumSet<E> clone() {
        try {
