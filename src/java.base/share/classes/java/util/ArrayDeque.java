                           ...
                           implements Deque<E>, Cloneable, Serializable
{
     ...
     */
    public @Modifiable @IteratorPreservesRemove ArrayDeque() {
     ...
     */
    public @Modifiable @IteratorPreservesRemove ArrayDeque(@NonNegative int numElements) {
        elements =
     ...
     */
    public @Modifiable @IteratorPreservesRemove @PolyNonEmpty ArrayDeque(@PolyNonEmpty Collection<? extends E> c) {
        this(c.size());
        copyElements(c);
    }
     ...
     */
    @SideEffectFree
    public @Modifiable @IteratorPreservesRemove ArrayDeque<E> clone(@GuardSatisfied ArrayDeque<E> this) {
        try {
            @SuppressWarnings("unchecked")
