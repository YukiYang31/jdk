                           ...
                           implements Deque<E>, Cloneable, Serializable
{
     ...
     */
    public @Modifiable @IteratorPolyShrink ArrayDeque() {
     ...
     */
    public @Modifiable @IteratorPolyShrink ArrayDeque(@NonNegative int numElements) {
        elements =
     ...
     */
    public @Modifiable @IteratorPolyShrink @PolyNonEmpty ArrayDeque(@PolyNonEmpty Collection<? extends E> c) {
        this(c.size());
        copyElements(c);
    }
     ...
     */
    @SideEffectFree
    public @Modifiable @IteratorPolyShrink ArrayDeque<E> clone(@GuardSatisfied ArrayDeque<E> this) {
        try {
            @SuppressWarnings("unchecked")
