    ...
    implements Set<E>, Cloneable, java.io.Serializable
{
     ...
     */
    public @Modifiable @IteratorPolyShrinkable HashSet() {
        map = new HashMap<>();
    }
     ...
     */
    public @Modifiable @IteratorPolyShrinkable @PolyNonEmpty HashSet(@PolyNonEmpty Collection<? extends E> c) {
     ...
     */
    public @Modifiable @IteratorPolyShrinkable HashSet(@NonNegative int initialCapacity, float loadFactor) {
     ...
     *             than zero
     */
    public @Modifiable @IteratorPolyShrinkable HashSet(@NonNegative int initialCapacity) {
     ...
     *             than zero, or if the load factor is nonpositive
     */
    @Modifiable @IteratorPolyShrinkable HashSet(int initialCapacity, float loadFactor, boolean dummy) {
    ...
    public @Modifiable @IteratorPolyShrinkable Object clone(@GuardSatisfied HashSet<E> this) {
        try {
