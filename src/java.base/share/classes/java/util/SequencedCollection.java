...
public interface SequencedCollection<E> extends Collection<E> {
    ...
    // @SideEffectsOnly("this")
    @DoesNotUnrefineReceiver("modifiability")
    default E removeFirst(@IteratorPolyShrinkable @Shrinkable SequencedCollection<E> this) {
    ...
    // @SideEffectsOnly("this")
    @DoesNotUnrefineReceiver("modifiability")
    default E removeLast(@IteratorPolyShrinkable @Shrinkable SequencedCollection<E> this) {
